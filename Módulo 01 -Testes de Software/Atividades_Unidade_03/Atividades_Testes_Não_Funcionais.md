...
* **Risco Associado:**
  * agendamento ou cancelamento de consultas via terceiros no nome do usuário em casos de dispositivos compartilhados.
...
* **O que será verificado:**
  * Se o comportamento do sistema permanece estável ao alternar entre diferentes sistemas operacionais.
* **Risco Associado:**
  * **Incompatibilidade de Scripts:** Recursos essenciais do fluxo de agendamento em um sistema operacional específico.

#### Compatibilidade de Entrada e Seleção de Dados em Dispositivos Touch
* **O que será verificado:**
  * Se os campos de entrada de dados ativam os teclados virtuais.
* **Risco Associado:**
  * **Erros de Digitação e Lentidão no Cadastro:** Dificuldade extrema para preencher dados cadastrais, ocasionando abandono ou dados incorretos.
