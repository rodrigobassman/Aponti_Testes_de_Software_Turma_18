...
a)	Performance:
b)	Segurança:
•	Autenticação de Usuários e Controle de Acesso: Usuários devem estar autenticados para agendar consultas e que haja uma área administrativa para gestão de horários.
