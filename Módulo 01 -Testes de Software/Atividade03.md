...
| **De quem é a responsabilidade?** | Do QA, que era visto como o único que "deixava passar" o bug. | De toda a gente. A equipa inteira (Devs, QAs e POs) cuida da qualidade. |
...
Muitas equipas tentam automatizar 100% dos testes para poupar tempo. O resultado prático costuma ser a criação de robôs de teste frágeis, que partem por qualquer bobeira (como a mudança de cor de um botão). A equipa acaba por gastar mais tempo a consertar os robôs de teste do que a testar o sistema real.
